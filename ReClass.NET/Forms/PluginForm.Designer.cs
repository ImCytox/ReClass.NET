...
namespace ReClassNET.Forms
{
	partial class PluginForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Plugins can provide different methods how R3Cl4ss.N3T accesses a remote process.\r" +
    ...
    "n.";
			...
			this.bannerBox.Text = "Here you can configure all loaded R3Cl4ss.N3T plugins.";
